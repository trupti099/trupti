...
@Component({
  selector: 'app-parcels-report',
  templateUrl: './parcels-report.component.html',
  styleUrls: ['./parcels-report.component.scss']
})
export class ParcelsReportComponent implements OnInit {
