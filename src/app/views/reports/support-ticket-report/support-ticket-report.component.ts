...
@Component({
  selector: 'app-support-ticket-report',
  templateUrl: './support-ticket-report.component.html',
  styleUrls: ['./support-ticket-report.component.scss']
})
export class SupportTicketReportComponent implements OnInit {
  displayedColumns = [
    "id",
    "title",
    "description",
